...
__redis_save_friends__ = RedisShortened(key=redis_save_friends, data={}, redis_client=redis_base)
__redis_save_chats__ = RedisShortened(key=redis_save_chats, data={}, redis_client=redis_base)